...
export default function Home() {
  ...
  return (
    <main>
      ...
      <Head>
        <title>Album – the debut album, available in a limited edition</title>
        <meta property="og:title" content="Album – the debut album, available in a limited edition" />
        <meta property="og:description" content="This is a project" />
        <meta property="og:url" content="https://www.album-band.com" />
